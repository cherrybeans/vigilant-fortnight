package com.kvamme.goldenpegasusius
...
class MainForegroundService : Service() {
    ...
    override fun onCreate() {
        Log.d("gold", "Started app blocking service.")
        super.onCreate()
    ...
    override fun onDestroy() {
        super.onDestroy()
        Log.d("gold", "App blocking service destroyed.")
    ...
    private fun checkIfShouldBlockForegroundApp() {
        ...
        if (hasUsageDataAccessPermission()) {
            ...
            if (prevDetectedForegroundAppPackageName != null && foregroundApp == null) {
                 ...
                 */
                Log.d("gold", "⏳ Still using $prevDetectedForegroundAppPackageName")
