package com.kvamme.goldenpegasusius.ui.settings
...
class RestrictAppsPreference : DialogPreference {
    ...
    fun setSelectedApps(input: Set<String>) {
        ...
        Log.d("gold", "Saved restricted apps: " + selectedApps.joinToString(", "))
    }
        ...
        return packageManager.getInstalledApplications(PackageManager.GET_META_DATA)
            .filter { appInfo ->
                isNotSystemPackage(appInfo)
                        // Our app should be excluded from the list
                        && appInfo.packageName != ("com.kvamme.goldenpegasusius")
            }
